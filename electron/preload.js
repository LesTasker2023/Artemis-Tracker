...
contextBridge.exposeInMainWorld("electron", {
  log: {
    start: function (manualPath) {
      return ipcRenderer.invoke("log:start", manualPath);
    },
    selectFile: function () {
      return ipcRenderer.invoke("log:select-file");
    },
    stop: function () {
      return ipcRenderer.invoke("log:stop");
    },
    status: function () {
      return ipcRenderer.invoke("log:status");
    },
    probe: function () {
      return ipcRenderer.invoke("log:probe");
    },
    readRaw: function (options) {
      return ipcRenderer.invoke("log:read-raw", options);
    },
  ...
  equipment: {
    load: function (type) {
      return ipcRenderer.invoke("equipment:load", type);
    },
  },
  session: {
    ...
    export: function (sessionId, path) {
      return ipcRenderer.invoke("session:export", sessionId, path);
    },
    import: function (path) {
      return ipcRenderer.invoke("session:import", path);
    },
  },
  popout: {
    open: function () {
      return ipcRenderer.invoke("popout:open");
    },
    close: function () {
      return ipcRenderer.invoke("popout:close");
    },
    sendStats: function (stats) {
      return ipcRenderer.send("popout:stats", stats);
    },
    ...
    requestStats: function () {
      return ipcRenderer.send("popout:request-stats");
    },
  ...
  asteroid: {
    save: function (asteroids) {
      return ipcRenderer.invoke("asteroid:save", asteroids);
    },
    load: function () {
      return ipcRenderer.invoke("asteroid:load");
    },
  },
  ipcRenderer: {
